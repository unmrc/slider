...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider */ "./src/blocks/slider/slider.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initBlock", function() { return _slider__WEBPACK_IMPORTED_MODULE_0__["initBlock"]; });
...
// Block name
var BLOCK_NAME = 'slider'; // Element class names
...
function initBlock() {
  var block = document.querySelector(SELECTOR.BLOCK);

  if (block == null) {
    return false;
  }

  var mySwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container', {
    // Optional parameters
    loop: true,
    autoplay: {
      delay: 5000
...
/* harmony import */ var _util_bx_panel_fix__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util/bx-panel-fix */ "./src/js/util/bx-panel-fix.js");
/* harmony import */ var _util_focus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util/focus */ "./src/js/util/focus.js");
/* harmony import */ var _util_lazy_loader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util/lazy-loader */ "./src/js/util/lazy-loader.js");
/* harmony import */ var _blocks_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../blocks/slider */ "./src/blocks/slider/index.js");
// Polyfill imports
...
svg4everybody__WEBPACK_IMPORTED_MODULE_2___default()(); // Initialize utilities

_util_focus__WEBPACK_IMPORTED_MODULE_4__["init"]();
_util_lazy_loader__WEBPACK_IMPORTED_MODULE_5__["init"]();
Object(_util_bx_panel_fix__WEBPACK_IMPORTED_MODULE_3__["default"])(function (panel, isFixed) {
  void panel;
  void isFixed;
});
_blocks_slider__WEBPACK_IMPORTED_MODULE_6__["initBlock"]();

/***/ }),

/***/ "./src/js/util/bx-panel-fix.js":
/*!*************************************!*\
  !*** ./src/js/util/bx-panel-fix.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return bxPanelFix; });
...
var SCROLL_INTERVAL = 100; // Element selectors
...
var isFixed = false; // Map of DOM elements

var elements = {}; // Throttled callback

var executeCallback = null; // --------------------------- END MODULE VARIABLES ---------------------------
// ---------------------------- BEGIN EVENT HANDLERS --------------------------
...
function bxPanelFix(callback) {
  var bxPanel = document.querySelector(SELECTOR.BX_PANEL);

  if (bxPanel == null) {
    return;
  }

  executeCallback = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["throttle"])(function () {
    callback(bxPanel.getBoundingClientRect(), isFixed);
  }, SCROLL_INTERVAL);
  var bxPanelPin = bxPanel.querySelector(SELECTOR.BX_PANEL_PIN);

  if (bxPanelPin != null) {
    bxPanelPin.addEventListener('click', executeCallback, false);
  }

  var bxPanelHider = bxPanel.querySelector(SELECTOR.BX_PANEL_HIDER);

  if (bxPanelHider != null) {
    bxPanelHider.addEventListener('click', executeCallback, false);
  }

  var bxPanelExpander = bxPanel.querySelector(SELECTOR.BX_PANEL_EXPANDER);
...
/*!************************************!*\
  !*** ./src/js/util/lazy-loader.js ***!
  \************************************/
/*! exports provided: scanImages, addImage, init */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var LAZY_CLASS = 'lazy'; // The list of all images 

var images = []; // Throttle the window scroll event handler

var handleWindowScroll = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["throttle"])(scanImages, SCROLL_INTERVAL); // --------------------------- END MODULE VARIABLES ---------------------------
// -------------------------- BEGIN UTILITY FUNCTIONS -------------------------
...
module.exports = __webpack_require__(/*! C:\Users\ВАня\Desktop\practice\slider\src\js\main.js */"./src/js/main.js");
